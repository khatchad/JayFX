...
public class TestJayFX extends TestCase {
	...
	public void testDeclares() {
		...
		assertTrue(lRange.contains(
				getElement("a.b.A.test1(I,Ljava.lang.String;,[Ljava.lang.String;,[[Ljava.lang.String;)", false)));
	...
	public void testNonProjectExtendsInterfaces() {
		Set lRange = aDB.getRange(getElement("javax.imageio.stream.ImageInputStream", true),
	...
	public void testTOverrides() {
		...
		// System.out.println(i.toString());
		// }
		assertEquals(2, lRange.size()); // TODO: it overrides itself as well??
		assertTrue(lRange.contains(getElement("a.b.D.equals(Ljava.lang.Object;)", false)));
	...
	public void testIsProjectElement() {
		...
		assertTrue(aDB.isProjectElement(
				getElement("a.b.A.test1(I,Ljava.lang.String;,[Ljava.lang.String;,[[Ljava.lang.String;)", false)));
	...
	public void testEnumDeclares() {
		Set lRange = aDB.getRange(getElement("ca.cs.mcgill.swevo.jayfxbenchmark.enumtest.Planet", true),
				Relation.DECLARES);
		for (Object i : lRange) {
			System.out.println(i.toString());
		}
		...
		lRange = aDB.getRange(getElement("ca.cs.mcgill.swevo.jayfxbenchmark.enumtest.Planet$Composition", true),
				Relation.DECLARES);
		assertEquals(3, lRange.size());
		assertFalse(lRange
				.contains(getElement("ca.cs.mcgill.swevo.jayfxbenchmark.enumtest.Planet$Composition.SOLID", false)));
	...
	public void testEnumAccess() {
		Set lRange = aDB.getRange(getElement(
	...
	public void testEnumTAccess() {
		Set lRange = aDB.getRange(getElement("ca.cs.mcgill.swevo.jayfxbenchmark.enumtest.Planet.JUPITER", false),
				Relation.T_ACCESSES);
		// for (Object i : lRange)
		// {
		// System.out.println(i.toString());
		...
		assertTrue(lRange
				.contains(getElement("ca.cs.mcgill.swevo.jayfxbenchmark.enumtest.Planet.getLargestPlanet()", false)));
	...
	public void testImportStatic() {
		Set lRange = aDB.getRange(
				getElement("ca.cs.mcgill.swevo.jayfxbenchmark.generictest.TLA_QandA.answer(Ljava.lang.String;)", false),
				Relation.ACCESSES);
		assertEquals(3, lRange.size());
