...
public class ProgramDatabase {
	 ...
	 */
	public void addRelation(IElement pElement1, Relation pRelation, IElement pElement2)
			throws ElementNotFoundException {
	 ...
	 *             database.
	 */
	public void addRelationAndTranspose(IElement pElement1, Relation pRelation, IElement pElement2)
			throws ElementNotFoundException {
		assert(pElement1 != null);
		assert(pElement2 != null);
		assert(pRelation != null);
	...
	public boolean hasRelations(IElement pElement) throws ElementNotFoundException {
		...
		Map lRelations = aElements.get(pElement).getRelationMap();
	...
	public void copyRelations(IElement pFrom, IElement pTo) throws ElementNotFoundException {
		...
		Map lRelations = aElements.get(pFrom).getRelationMap();
	 ...
	 *             If either pFrom or pTo is not indexed in the database.
	 */
	private void removeRelation(IElement pElement1, Relation pRelation, IElement pElement2)
			throws ElementNotFoundException {
		assert(pElement1 != null);
		assert(pElement2 != null);
		assert(pRelation != null);
		...
		Map lRelations = aElements.get(pElement1).getRelationMap();
		if (!lRelations.containsKey(pRelation))
			return;
	...
	public int getModifiers(IElement pElement) {
		int lReturn = 0;
		if (aElements.containsKey(pElement)) {
			Bundle lBundle = aElements.get(pElement);
